    ...
    <><div className="bg-white pb-6 sm:pb-8 lg:pb-12">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4 lg:gap-8">
            <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 lg:p-8">
              <div className="mb-2 h-24 w-24 overflow-hidden rounded-full bg-gray-200 shadow-lg md:mb-4 md:h-32 md:w-32">
                <img src="/icons/icon_4.png" loading="lazy" alt="Photo by Radu Florin" className="h-full w-full object-cover object-center" />
              </div>

              <div>
                <div className="text-center font-bold text-indigo-500 md:text-lg">Hiroshi Takagi</div>
        ...
        <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
          ...
          <div className="border-t border-gray-800 py-8 text-center text-sm text-gray-400">© 2023 - Volunteer Network. All rights reserved.</div>
        </footer>
      </div></>
  )
}
